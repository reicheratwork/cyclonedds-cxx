...
const char* string_template = "std::string";
const char* string_include = "<string>";
const char* bounded_string_template = "std::string";
const char* bounded_string_include = "<string>";
